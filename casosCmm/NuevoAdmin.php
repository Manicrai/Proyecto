  ...
  require_once 'bdconnect.php'; //conexion a la bd
    ...
    $departamento = $_POST['departamento'];
          ...
          $usuario = generate_login($_POST["nombre"], $_POST["apellido"]);
            $db =  new database();
            $query = $db->connect()->prepare("INSERT INTO usuarios (usuario, nombre, apellido, extension, ubicacion, cedula, id_departamento, correo, id_cargo, password, tipo_usuario, estado_usuario) VALUES ('$usuario', '$nombre', '$apellido', '$extension', '$ubicacion', '$cedula', '$departamento', '$correo', '$cargo', '$password', '3', '1' )");
    ...
    Swal.fire({ 
                ...
                allowOutsideClick: true 
                  ...
                  if (resultado.isConfirmed) {
                    window.location.href= 'CrearAdmin.php';
                    }
              })
  </script>