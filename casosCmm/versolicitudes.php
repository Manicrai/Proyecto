            ...
            $.ajax({
                           ...
                           //       dataType: "json", 
                                    success: function(respuesta) {
                                        ...
                                        window.location.href = "solicitudes_aprobacion.php";
                                    }  
                    })
        }
    </script>
    ...
    <?php     
                ...
                <?php 
                    require_once 'bdconnect.php'; //mostramos los casos del usuario en una tabla
                        ...
                        $db =  new database();
                        $query = $db->connect()->prepare("SELECT c.id, c.titulo, c.solicitante, cc.categoria, d.departamento, c.fecha_ingreso, c.fecha_actualizacion, c.descripcion_caso, p.prioridad, e.estado, c.analista, c.aprobacion  FROM casos AS c 
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="table-responsive">
                                <h1 class="mt-3"> Lista de Solicitudes</h1><br><br>
