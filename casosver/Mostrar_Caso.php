        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                ?>
                    ...
                    <div class="center" style="margin: 0px -10%; height: auto; position: absolute;">
                        <form class="" >
                            ...
                            <div class="email">
                                <div class="inputbox">
                                    <label>Solicitante</label>
                                         <input type="text" name="" id="" placeholder="<?php echo $nsolicitante ;?>" readonly="readonly" style="border: 0;">
                                </div>   
                            </div>
                            <div class="name">
                                <br>
