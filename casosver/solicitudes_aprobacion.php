<?php 
    ...
    if (!isset($_SESSION["usuario"])) { //validamos si hay una session activa en caso contrario lo mandamos a cagar
        session_start();
        $db =  new database();
...
<head>
    ...
    <script type="text/javascript">
        ...
        async function desaprobed(p_id){
            const { value: text } = await Swal.fire({
                                                    input: 'textarea',
                                                    icon : 'question',
                                                    inputLabel: '¿Motivo?',
        ...
        <!-- Sidebar Toggle (Topbar) -->
            ...
            <!-- Topbar Search -->     
                ...
                <li class="nav-item active" style="position: absolute; left: 60%;">      
                   <a href="versolicitudes.php">  <span>Solicitudes Por Aprobar</span> </a>
                </li>
                    <!-- Topbar Navbar -->
                ...
                <div id="container">
                    <div class="center"  style="box-shadow: rgba(0, 0, 0, 0.25) 0px 54px 55px, rgba(0, 0, 0, 0.12) 0px -12px 30px, rgba(0, 0, 0, 0.12) 0px 4px 6px, rgba(0, 0, 0, 0.17) 0px 12px 13px, rgba(0, 0, 0, 0.09) 0px -3px 5px;">
                        <form class="" >
                            ...
                            ?>
                                    <div class="name">
                                        ...
                                        <div class="inputbox">
                                            ...
                                            <input type="text" name="" id="" placeholder="<?php echo $aprobacion ;?>" readonly="readonly" style="border: 0;">
                                        </div>
                                    </div>
                                    <div class="email">
                                        <br>
                                        <div class="inputbox">
                                            ...
                                            <input type="text" name="" id="" placeholder="<?php echo $comentario_aprobacion ;?>" readonly="readonly" style="border: 0;">
                                        </div>
                                    </div>
                                    <?php
                                    } 
                            ...
                            <div class="name">
                                <div class="inputbox">
                                    <input type="button" name="" id="" value="Aprobar" onclick="aproved( <?php echo $ncaso; ?>)">
                                </div>
                            </div>
                            <div class="email">
                                <div class="inputbox">
                                    <input type="button" name="" id="" value="Rechazar" onclick="desaprobed( <?php echo $ncaso; ?>)">
                                </div>
                            </div>
                        </form>
                    </div>
