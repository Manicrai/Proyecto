...
<head>
   ...
   <script> 
        ...
        function newanalista(p_id){
            var id = p_id;
            analista =document.getElementById("analistad"+id).value;
            alert  (analista);
                        ...
                        <h1>Casos No Asignados</h1>  <br><br>    
                            ...
                            ?>
                                        <tr>
                                            ...
                                            <td>
                                                <div class="tab" >
                                                    <select name="valor9" <?php echo 'id="analistad'.$fila["id"].'"';?> onchange="newanalista(<?php echo $fila['id']; ?>)">
                                                        <?php 
                                                            $db =  new database();
                                                                $quer = $db->connect()->prepare("SELECT CONCAT(nombre, ' ', apellido) Analistas FROM usuarios WHERE tipo_usuario = 2 ");
                                                                $quer -> execute();
                                                                $row = $quer->fetchAll(); 
