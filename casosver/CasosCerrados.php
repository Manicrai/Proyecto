                    ...
                    <div class="col-lg-12">
                        ...
                        ?>
                                    <tr>
                                        ...
                                        <td><input type="button" name="" value="Re-Abrir" style="  width: 100%; background: dodgerblue; color: #fff; border: #fff; border-radius: 8px; " onclick="reabrir(<?php echo $fila['id']; ?>)">
                                        </td>
