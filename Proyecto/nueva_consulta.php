  ...
  <main id="main" class="main">
    <div class="pagetitle">
      ...
      ?>
        ...
        <form action="consulta_terminada.php" method="POST">
            <div class="container">
                    ...
                    <div class="row align-items-start">      
                        ...
                        <div class="col-6">
                            <div class="offset-sm-0 col-md-5 offset-md-7">
                                <button type="submit"  value="">Terminar consulta</button>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-sm">
                            ...
                            <input type="text" name="valor_consulta" class="form-control">
                        </div>
                    </div>
                    <br>
                    <br>
                ...
                <div class="card info-card customers-card">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane fade show active" id="medica">
                            <div class="row">
                                ...
                                <div class="col-5">
                                    ...
                                    <textarea class="form-control" name="motivo_consulta" id="" rows="8" ></textarea>
                                    <label class="col-sm-6 col-form-label">Exploración Fisica</label>
                                    <textarea class="form-control" name="exploracion_fisica" id=" "rows="8" ></textarea>  
                                </div>
                                <div class="col-5">
                                    <label class="col-sm-6 col-form-label">Sintomas subjetivos</label>
                                    <textarea class="form-control" name="sintomas_subjetivos" id=""rows="8" ></textarea>
                                    <label for="user" class="col-sm-6 col-form-label">Diagnóstico</label>
                                    <textarea class="form-control" name="diagnostico" id=""rows="8" ></textarea> 
                                </div>   
                            </div>
                        </div>
                        <div class="tab-pane fade" id="recetas">
                            <div class="row">
                                <div class="col-sm">
                                    <label class="col-sm-10 col-form-label">Medicamento</label>
                                    <input type="text" id="medicamento" name="medicamento" class="form-control">
                                </div>
                                <div class="col-sm">
                                    <label class="col-sm-10 col-form-label">Concentración</label>
                                    <input type="text" id="concetracion" class="form-control">
                                </div>
                                <div class="col-sm">
                                    <label class="col-sm-9 col-form-label">Tomar</label>
                                    <input type="text" id="tomar" class="form-control">
                                </div>
                                <div class="col-sm">
                                    <label class="col-sm-9 col-form-label">Frecuencia</label>
                                    <input type="text" id="frecuencia" class="form-control">
                                </div>
                                <div class="col-sm">
                                    <label class="col-sm-9 col-form-label">Durante</label>
                                    <input type="text" id="durante" class="form-control">
                                </div>
                                <div class="col-sm">
                        ...
                        <div class="tab-pane fade" id="historial_medico">
                            ...
                            <div class="row">
                                <div class="col-4">
                                    ...
                                    <textarea name="alergias" value="" class="form-control"  id="alergias" rows="5" ><?php echo $alergias ?></textarea>
                                    <label for="user" class="col-sm-6 col-form-label">Enfermedad Cronicas</label>
                                    <textarea name="cronicas" value="" id="cronicas"class="form-control" rows="5"><?php echo $cronicas ?></textarea> 
                                </div>
                                <div class="col-4">
                                    <label for="user" class="col-sm-8 col-form-label">Antecedentes Quirurgicos</label>
                                    <textarea class="form-control" value="" name="quirurgicos" id="quirurgicos"rows="5" ><?php echo $quirurgicos ?></textarea>
                                    <label for="user" class="col-sm-6 col-form-label">Antecedentes Familiares</label>
                                    <textarea class="form-control" value="" name="familiar" id="familiar"rows="5"><?php echo $familiar ?></textarea>
                                </div>
                                <div class="col-4">
                                    <label for="user" class="col-sm-10 col-form-label">Antecedentes Ginecologicos</label>
                                    <textarea class="form-control"value="" name="ginecologicos" id="ginecologicos"rows="5" ><?php echo $ginecologicos ?></textarea>
                                    <label for="user" class="col-sm-10 col-form-label">Otros (medicamentos, Traumatismos...)</label>
                                    <textarea class="form-control" value="" name="otros" id="otros"rows="5" ><?php echo $otros ?></textarea>
                                </div>
                            </div>
                            <br>
                            <br>
                            ...
                            <div class="row">
                                <div class="col-4">
                                    <label for="user" class="col-sm-5 col-form-label" >Alergias</label>
                                    <textarea name="alergias" value="" class="form-control"  id="alergias" rows="5" ></textarea>
                                    <label for="user" class="col-sm-6 col-form-label">Enfermedad Cronicas</label>
                                    <textarea name="cronicas" value="" id="cronicas"class="form-control" rows="5"></textarea> 
                                </div>
                                <div class="col-4">
                                    <label for="user" class="col-sm-8 col-form-label">Antecedentes Quirurgicos</label>
                                    <textarea class="form-control" value="" name="quirurgicos" id="quirurgicos"rows="5" ></textarea>
                                    <label for="user" class="col-sm-6 col-form-label">Antecedentes Familiares</label>
                                    <textarea class="form-control" value="" name="familiar" id="familiar"rows="5"></textarea>
                                </div>
                                <div class="col-4">
                                    <label for="user" class="col-sm-10 col-form-label">Antecedentes Ginecologicos</label>
                                    <textarea class="form-control"value="" name="ginecologicos" id="ginecologicos"rows="5" ></textarea>
                                    <label for="user" class="col-sm-10 col-form-label">Otros (medicamentos, Traumatismos...)</label>
                                    <textarea class="form-control" value="" name="otros" id="otros"rows="5" ></textarea>
                                </div>
                            </div>
                            <br>
                            <br>
                        ...
                        <div class="tab-pane fade" id="examenes">
                            <div class="col-10">
                                ...
                                <textarea name="estudio_examen" value="" class="form-control"  id="" rows="5" ></textarea>
                            </div>
                            <br>
                            <br>
                        </div>
